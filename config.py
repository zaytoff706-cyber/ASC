...
VALIDATION_CHANNEL_ID = int(os.getenv("VALIDATION_CHANNEL_ID") or "0")
PROOF_CHANNEL_ID = int(os.getenv("PROOF_CHANNEL_ID") or "0")

VERIFIED_ROLE_ID = int(os.getenv("VERIFIED_ROLE_ID") or "0")
BYPASS_ROLE_ID = int(os.getenv("BYPASS_ROLE_ID") or "1551706822216519800")
REJECT_ROLE_ID = int(os.getenv("REJECT_ROLE_ID") or "0")

COOLDOWN_SECONDS = int(os.getenv("COOLDOWN_SECONDS") or "300")
PROOF_TIMEOUT_SECONDS = int(os.getenv("PROOF_TIMEOUT_SECONDS") or "300")
